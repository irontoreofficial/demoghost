...
var $t = (u, v, k) =>
  v in u ? Tt(u, v, { enumerable: !0, configurable: !0, writable: !0, value: k }) : (u[v] = k);
var a = (u, v, k) => $t(u, typeof v != "symbol" ? v + "" : v, k);
(function (u) {
  "use strict";
  ...
  class D {
    ...
    get(t) {
      ...
      if (!e) throw new q(`Unknown action type "${t}". Did you forget to register it?`);
      return e;
    }
    has(t) {
    ...
    for (; s > 0 && !n.signal.aborted;) {
      ...
      (await new Promise(c => {
        const h = () => {
          ...
          l = setTimeout(() => {
            (n.signal.removeEventListener("abort", h), c());
          }, r);
        n.signal.addEventListener("abort", h, { once: !0 });
      }),
        (s -= performance.now() - o));
    }
  }
  function wt(n) {
    (n.register("move", async t => {
      ...
      const s = b(i);
      (t.cursor.setState(M(i) ? "pointer" : "default"),
      ...
      n.register("type", async t => {
        ...
        typeof i.focus == "function" && i.focus();
        const r = i;
        e.clearFirst && "value" in r && (S(r, "value", ""), C(r));
        const o = String(e.value || ""),
          c = e.speed ?? t.options.typingSpeed ?? "human",
          h = t.options.deterministic ?? !1;
        for (let l = 0; l < o.length; l++) {
          if ((await t.waitIfPaused(), t.signal.aborted)) return;
          const d = o[l];
          (i.dispatchEvent(new KeyboardEvent("keydown", { key: d, bubbles: !0 })),
            i.dispatchEvent(new KeyboardEvent("keypress", { key: d, bubbles: !0 })),
            "value" in r && (S(r, "value", r.value + d), C(r)),
            i.dispatchEvent(new KeyboardEvent("keyup", { key: d, bubbles: !0 })));
          const f = yt(c, h);
          f > 0 && (await T(t, f));
        }
      ...
      n.register("wait", async t => {
        ...
        if (typeof e.condition == "function") {
          ...
          throw new H("custom condition", i);
        }
        if (e.selector) {
          const i = e.timeout ?? 5e3,
            s = e.state ?? "visible",
          ...
          throw new H(`selector "${e.selector}" state "${s}"`, i);
        }
      }),
      ...
      n.register("check", async t => {
        ...
        (await t.cursor.moveTo(s.x, s.y, 400),
          ...
          "checked" in i &&
            !i.checked &&
            (i.click(), i.checked || (S(i, "checked", !0), C(i, !0))));
      }),
      n.register("uncheck", async t => {
        ...
        (await t.cursor.moveTo(s.x, s.y, 400),
          await t.cursor.click(),
          "checked" in i && i.checked && (i.click(), i.checked && (S(i, "checked", !1), C(i, !0))));
      }),
      n.register("hover", async t => {
        ...
        (t.cursor.setState(M(i) ? "pointer" : "default"),
          ...
          e.duration && e.duration > 0 && (await T(t, e.duration)));
      }),
      ...
      n.register("caption", async t => {
        ...
        (e.target && (i = (await t.targetResolver.resolveOptional(e.target, t.signal)) || void 0),
          ...
          e.options.duration && (await T(t, e.options.duration), t.spotlightEngine.hideCaption()));
      }),
  ...
  class z {
    ...
    async resolve(t, e, i) {
      ...
      const r = this.normalizeTarget(t),
        o = r.selector,
        c = r.timeout;
      throw new k(typeof o == "string" ? o : "<HTMLElement>", c, e);
    }
          ...
          : new Promise(d => {
              ...
              const R = () => {
                  ((f = !0),
                    ...
                    w !== null &&
                      ...
                      (cancelAnimationFrame(w), (w = null)),
                    i == null || i.removeEventListener("abort", P));
                },
                P = () => {
                  (R(), d(null));
                },
              ...
              ((g = setTimeout(() => {
                ...
                typeof MutationObserver < "u" &&
                  ...
                  y.observe(document.body || document.documentElement, {
                    childList: !0,
                    subtree: !0,
                    attributes: !0
                  })),
                typeof requestAnimationFrame < "u" && (w = requestAnimationFrame(ft)),
    ...
    queryByText(t) {
      ...
      try {
        const o = Array.from(document.querySelectorAll(e)),
          c = [];
        for (const h of o) {
          const l = (h.textContent || "").trim();
          s ? l.toLowerCase() === r && c.push(h) : l.toLowerCase().includes(r) && c.push(h);
        }
        return c.length === 0
          ? null
          : (c.sort((h, l) => (h.contains(l) ? 1 : l.contains(h) ? -1 : 0)), c[0] || null);
      } catch {
        return null;
      }
    }
  ...
  function Et(n, t, e, i, s) {
    const r = 1 - s,
      ...
      l = o * s;
    return {
      x: h * n.x + 3 * c * s * t.x + 3 * r * o * e.x + l * i.x,
      y: h * n.y + 3 * c * s * t.y + 3 * r * o * e.y + l * i.y
    };
  }
  function kt(n, t, e = !1) {
    const i = t.x - n.x,
    ...
    const o = -s / r,
      c = i / r,
      h = Math.min(r * 0.25, 80),
      l = e ? 0.6 : 0.4 + Math.random() * 0.6,
      d = e || Math.random() > 0.5 ? 1 : -1,
      f = h * l * d,
      g = h * (l * 0.7) * d,
      y = { x: n.x + i * 0.25 + o * f, y: n.y + s * 0.25 + c * f },
      w = { x: n.x + i * 0.75 + o * g, y: n.y + s * 0.75 + c * g };
    return [y, w];
  }
  class F {
    constructor(t = {}) {
      ...
      a(this, "pendingTimers", new Map());
      a(this, "ripples", new Set());
      a(this, "container");
    ...
    async moveTo(t, e, i = 600) {
      ...
      const o = kt(s, r, this.deterministic),
        c = o[0],
        h = o[1];
        ...
        const d = performance.now(),
          f = g => {
            ...
            (this.updatePosition(P),
              w < 1
                ? (this.activeAnimation = requestAnimationFrame(f))
                : (this.updatePosition(r),
  ...
  class x {
    constructor(t = {}) {
      ...
      this.config = { behavior: "smooth", offset: 80, ...t };
    }
    async scrollIntoView(t, e) {
      ...
      const i = e ?? this.config.offset ?? 80,
        ...
        h = s.left >= 0 && s.right <= o;
      if (c && h) return;
      const l = window.scrollY || window.pageYOffset,
        d = Math.max(0, l + s.top - i);
      await this.scrollTo(window.scrollX || window.pageXOffset, d, this.config.behavior);
    }
      ...
      if (!(Math.hypot(t - r, e - s) < 5))
        return (
          ...
          new Promise(c => {
            ...
            this.activeScroll = { interval: g, resolve: c };
          })
        );
    }
    finishActiveScroll() {
      ...
      if (
        ...
        r === "top"
          ? ((c = s.top - this.captionEl.offsetHeight - o),
            (h = s.left + s.width / 2 - this.captionEl.offsetWidth / 2))
          : r === "left"
            ? ((c = s.top + s.height / 2 - this.captionEl.offsetHeight / 2),
              (h = s.left - this.captionEl.offsetWidth - o))
            : r === "right"
              ? ((c = s.top + s.height / 2 - this.captionEl.offsetHeight / 2), (h = s.right + o))
              : ((c = s.bottom + o), (h = s.left + s.width / 2 - this.captionEl.offsetWidth / 2));
        const l = 12;
        ((h = Math.max(l, Math.min(window.innerWidth - this.captionEl.offsetWidth - l, h))),
          (c = Math.max(l, Math.min(window.innerHeight - this.captionEl.offsetHeight - l, c))),
          (this.captionEl.style.transform = `translate3d(${Math.round(h)}px, ${Math.round(c)}px, 0)`));
      } else
  ...
  class G {
    ...
    initEngines() {
      typeof window > "u" ||
        ...
        j.apply(this.options.theme, this.options.container),
        (this.targetResolver = new z(this.options.defaultTimeout ?? 5e3)),
        (this.cursorEngine = new F({
          pointerMode: this.options.pointer,
          cursor: this.options.cursor,
          container: this.options.container,
          deterministic: this.options.deterministic
        })),
        (this.scrollEngine = new x(this.options.scroll)),
        (this.spotlightEngine = new B(this.options.container)),
        (this.a11y = new W()),
        this.a11y.saveFocus(),
    ...
    async executeStep(t, e) {
      ...
      if (
        ...
        const h = typeof t.caption == "string" ? t.caption : t.caption.text;
        this.a11y.announce(h);
        ...
        (t.target &&
          ...
          this.spotlightEngine.showCaption(l, d));
      }
      t.delayBefore &&
        t.delayBefore > 0 &&
        (await this.waitForDuration(t.delayBefore / this._speed));
      const r = {
        step: t,
        stepIndex: e,
        ...
        log: (h, ...l) => this.log(h, ...l)
      };
      (await i.execute(r),
        t.delayAfter &&
          t.delayAfter > 0 &&
          (await this.waitForDuration(t.delayAfter / this._speed)));
  ...
  const m = class m {
    static configure(t) {
      m.globalConfig = { ...m.globalConfig, ...t };
    }
    static play(t, e = {}) {
      m.activeController &&
        (m.activeController.state === "playing" || m.activeController.state === "paused") &&
        m.activeController.stop();
      const i = Array.isArray(t) ? { steps: t } : t,
        s = { ...m.globalConfig, ...e },
        r = new G(i, s, m.actions, m.globalEmitter);
      return (
        (m.activeController = r),
        s.autoStart !== !1 &&
          r.play().catch(o => {
    ...
    static create(t, e = {}) {
      return { play: (i = {}) => m.play(t, { ...e, ...i }) };
    }
    static on(t, e) {
      return m.globalEmitter.on(t, e);
    }
    static off(t, e) {
      m.globalEmitter.off(t, e);
    }
  };
  (a(m, "globalConfig", {}),
    a(m, "actions", new D()),
    a(m, "globalEmitter", new N()),
    wt(m.actions),
    a(m, "activeController", null));
  let E = m;
  typeof window < "u" && (window.DemoGhostCore = E);
  class ht {
    constructor(t = {}) {
    ...
    generate(t) {
      ...
      for (const l of i) {
        const d = t.getAttribute(l);
        if (d) {
          const g = `${t.tagName.toLowerCase()}[${l}="${CSS.escape(d)}"]`;
          if (this.isUnique(g)) return g;
        }
      }
      const s = t.getAttribute("role");
      if (s) {
        const d = `${t.tagName.toLowerCase()}[role="${CSS.escape(s)}"]`;
        if (this.isUnique(d)) return d;
        const f = t.getAttribute("aria-label");
        if (f) {
          const g = `[role="${CSS.escape(s)}"][aria-label="${CSS.escape(f)}"]`;
          if (this.isUnique(g)) return g;
        }
      }
...
`)
          ...
          const d = `${r}:contains("${l.replace(/"/g, '\\"')}")`;
          if (
            Array.from(document.querySelectorAll(r)).filter(g => (g.textContent || "").trim() === l)
              .length === 1
          )
            return d;
        }
      ...
      if (c) return c;
      const h = this.getContextualSelector(t);
      return h || this.getHierarchicalPath(t);
    }
    ...
    getHierarchicalPath(t) {
      ...
      for (; i && i !== document.body && i !== document.documentElement && s < this.maxDepth;) {
        ...
        if (o) {
          const h = Array.from(o.children).filter(l => l.tagName === i.tagName);
          if (h.length > 1) {
  ...
  class pt {
    constructor(t = {}) {
      ...
      var e, i, s;
      ((this.options = { captureScroll: !0, captureKeyboard: !0, minWaitDuration: 600, ...t }),
        (this.selectorGen = new ht(t.selector)),
        (this.privacyMasker = new dt({
          ...t.privacy,
          ...
          ignoreSelectors:
            t.ignoreSelectors ?? ((s = t.privacy) == null ? void 0 : s.ignoreSelectors)
        })));
    }
    start() {
      typeof window > "u" ||
    ...
    handleClick(t) {
      ...
      s && (this.appendWaitIfNecessary(), this.steps.push({ type: "click", target: s }));
    }
    handleInput(t) {
      const e = t.target;
      !e ||
        ...
        (this.isTextEntryElement(e) &&
          (this.activeInputElement !== e &&
            (this.flushActiveInput(), (this.activeInputElement = e)),
    ...
    flushActiveInput() {
      ...
      if (e) {
        ...
        (this.appendWaitIfNecessary(),
          this.steps.push({ type: "type", target: e, value: i, clearFirst: !0 }));
      }
    ...
    handleChange(t) {
      ...
      if (i === "select") {
        ...
        r &&
          (this.appendWaitIfNecessary(),
          this.steps.push({ type: "select", target: r, value: s.value }));
      } else if (i === "input") {
        const s = e,
        ...
        if (r === "checkbox" || r === "radio") {
          ...
          o &&
            (this.appendWaitIfNecessary(),
            this.steps.push({ type: s.checked ? "check" : "uncheck", target: o }));
        }
      }
    }
    handleKeydown(t) {
      ...
      (this.appendWaitIfNecessary(),
        this.steps.push({ type: "press", key: t.key, ...(s ? { target: s } : {}) }));
    }
    ...
    handleScroll() {
      ...
      const e = window.scrollY,
        i = window.scrollX;
      (e > 0 || i > 0) &&
        (this.steps.push({ type: "scrollTo", x: i, y: e, behavior: "smooth" }),
        (this.lastActionTime = t));
    }
  }
  const St = new Set([
  ...
  class I {
    ...
    static toTypeScript(t) {
      const e = new Set(),
        i = t.steps.map(
          o => (
            St.has(o.type) && e.add(o.type === "wait" && o.selector ? "waitFor" : o.type),
...
`;
    ...
    static formatStepCode(t, e = "") {
      ...
      switch (t.type) {
        ...
        case "wait": {
          if (t.selector) {
            const o = { selector: t.selector, ...this.pickOptions(t, ["type", "selector"]) };
  ...
  class V {
    constructor(t, e = {}) {
      ...
      a(this, "unsubs", []);
      ((this.controller = t),
        (this.options = { showStepBadge: !0, showProgress: !0, showSpeed: !0, ...e }),
        this.mount(),
        this.bindEvents());
    }
    mount() {
    ...
    bindEvents() {
      const t = s => {
          var h, l, d, f;
          const r = (h = this.rootElement) == null ? void 0 : h.querySelector("#dg-controls-step");
          r && (r.textContent = `${s.index + 1} / ${s.total}`);
          const o = (l = this.rootElement) == null ? void 0 : l.querySelector("#dg-controls-bar");
          if (o) {
            const g = ((s.index + 1) / s.total) * 100;
            o.style.width = `${g}%`;
          }
          const c = (d = this.rootElement) == null ? void 0 : d.querySelector("#dg-controls-title");
          if (c) {
            const g =
              typeof s.step.caption == "string"
                ? s.step.caption
                : ((f = s.step.caption) == null ? void 0 : f.title) || s.step.type;
            c.textContent = g;
          }
        },
        e = () => {
  ...
  const p = class p {
    ...
    static play(t, e = {}) {
      const i = E.play(t, e);
      return (e.controls !== !1 && new V(i, { container: e.container }), i);
    }
    static record(t = {}) {
      return L.record(t);
    }
    static create(t, e = {}) {
      return { play: (i = {}) => p.play(t, { ...e, ...i }) };
    }
    static serialize(t) {
    ...
    static toTypeScript(t) {
      return L.toTypeScript(t);
    }
    static toJavaScript(t) {
      return L.toJavaScript(t);
    }
    static export(t, e = "json") {
      return e === "ts" ? p.toTypeScript(t) : e === "js" ? p.toJavaScript(t) : p.serialize(t);
    }
    static on(t, e) {
      return E.on(t, e);
    }
  ...
  (a(p, "actions", E.actions),
    ...
    a(p, "drag", ut));
  let A = p;
  (typeof window < "u" && ((window.DemoGhost = A), (window.dg = A)),
    (u.AccessibilityManager = W),
    (u.ActionRegistry = D),
    (u.CursorEngine = F),
    (u.DemoGhost = A),
    (u.DemoGhostConfigurationError = vt),
    (u.DemoGhostControls = V),
    (u.DemoGhostCore = E),
    (u.DemoGhostError = v),
    (u.DemoGhostPlaybackError = q),
    (u.DemoGhostRecorder = L),
    (u.DemoGhostRecordingError = mt),
    (u.DemoGhostTargetNotFoundError = k),
    (u.DemoGhostTimeoutError = H),
    (u.EventEmitter = N),
    (u.EventRecorder = pt),
    (u.PlaybackController = G),
    (u.PrivacyMasker = dt),
    (u.ScenarioSerializer = I),
    (u.ScrollEngine = x),
    (u.SelectorGenerator = ht),
    (u.SpotlightEngine = B),
    (u.TargetResolver = z),
    (u.ThemeManager = j),
    (u.attachControls = Ct),
...
})((this.DemoGhost = this.DemoGhost || {}));
//# sourceMappingURL=demoghost.min.js.map
